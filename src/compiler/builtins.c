...
const struct GlobalFunctionData FUNCTIONS[] = {
    ...
    [GLOBAL_FUNC_NEG]          = { NEG_BYTECODE,          arr_len(NEG_BYTECODE) },
    ...
    [GLOBAL_FUNC_NOT]          = { NOT_BYTECODE,          arr_len(NOT_BYTECODE) },
    [GLOBAL_FUNC_FORCE]        = { FORCE_BYTECODE,        arr_len(FORCE_BYTECODE) },
